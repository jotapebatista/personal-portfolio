...
<motion.h3
  ...
  className="text-gray-400 font-Header text-sm md:text-lg sm:text-md mt-10 tracking-wider "
>
  I&apos;m a Junior <span className="text-AAsecondary">Full Stack Developer</span>, with strong{" "}
  ...
  and <span className="text-AAsecondary">back-end development</span>, I work with a diverse range of technologies, I enjoy solving challenging projects that
