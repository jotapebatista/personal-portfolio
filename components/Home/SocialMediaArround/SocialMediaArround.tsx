  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/jotapebatista"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/jotapebatista//"} />
            {/* Instagram Icon */}
      ...
      <motion.div
        ...
        transition={{ y: { delay: props.finishedLoading ? 0 : 11, duration: props.finishedLoading ? 0 : 0.5 } }}
        className="z-10 fixed bottom-0 -right-16 hidden lg:flex flex-row items-center justify-between"
      >
        <div className="flex flex-col space-y-32 justify-center items-center">
          ...
          >
			...
			<a href="mailto:abdellatif@anaflous.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                joao-oliveirabatista<span className="text-AAsecondary">@</span>anaflous<span className="text-AAsecondary">.</span>com
              </span>
            </a>
          </motion.div>
