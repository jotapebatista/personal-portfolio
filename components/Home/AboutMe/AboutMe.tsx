...
export default function AboutMe(props) {
	const technologies = [
		...
		["Node.js", "Java", "mySQL", "RESTful APIs"],
	];
	return (
		<div
			id="aboutSection"
		...
		>
			...
			<div className="flex flex-col space-y-8 px-4 sm:px-0 w-full sm:w-[500px] md:w-[700px] lg:w-[900px]">
					...
					<div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
						<div className="font-Header text-justify">
							<span className="text-gray-400 ">
								Hello! My name is João, and I&apos;m a
								passionate{" "}
								<span className="text-AAsecondary">
									Full Stack Software Developer
								</span>{" "}
								with strong problem-solving skills.
								{/* My journey in computer science started at 11 years old when I explored Ethical Hacking using BackTrack OS,
                ...
                in this field. */}
						...
						<div className="font-Header text-justify">
							<span className="text-gray-400 ">
								Throughout my education and career, from my
								self-learning days to earning my degrees,
								I&apos;ve gained experience in various
								industries.
								<span className="text-AAsecondary">
									{" "}
									With the 14-week coding bootcamp
								</span>
								, I conquered ignited passion for both front-end
								and back-end technologies. My coding journey is
								fueled by the excitement of bringing creative
								visions to life.
							</span>
						</div>
						...
						<div className="font-Header tracking-wide text-justify ">
							<span className="text-gray-400  ">
								I&apos;m always interested to keep learning and
								improve my skills to make a positive impact in
								the tech world. Here are some of the
