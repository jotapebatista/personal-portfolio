...
export default function AboutMe(props) {
  const technologies = [
    ["Nextjs/React", "Nuxt.js/Vue", "dotNet/C#", "TypeScript/JavaScript", "Tailwind CSS" ],
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header text-justify">
              <span className="text-gray-400 ">
                Hello! My name is João, and I&apos;m a passionate{" "}
                <span className="text-AAsecondary">Full Stack Software Developer</span> with strong problem-solving skills. 
            ...
            <div className="font-Header text-justify">
              <span className="text-gray-400 ">
				...
				<span className="text-AAsecondary"> With the 14-week coding bootcamp</span>,
				I conquered ignited passion for both front-end and back-end technologies. My coding journey is fueled by the excitement of bringing creative visions to life.
